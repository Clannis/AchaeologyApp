...
dig_site1 = DigSite.create(name: "0001", location: "spain", archaeologist: user1, user_id: user1.id)
...
artifact1 = Artifact.create(local_id: "01", type: "knife", description: "knife made out of flint rock", level_id: level1.id)
artifact2 = Artifact.create(local_id: "01", type: "bowl", description: "pottery bowl", level_id: level2.id)
artifact2 = Artifact.create(local_id: "01", type: "ring", description: "golden ring", level_id: level3.id)
artifact4 = Artifact.create(local_id: "01", type: "sherd", description: "pottery sherd", level_id: level4.id)
artifact5 = Artifact.create(local_id: "01", type: "glass", description: "piece of glass", level_id: level5.id)
artifact6 = Artifact.create(local_id: "01", type: "pipe", description: "corncob pipe", level_id: level6.id)
artifact7 = Artifact.create(local_id: "01", type: "shard", description: "pottery shard", level_id: level8.id)